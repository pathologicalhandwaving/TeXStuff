...
\fancyhead[C]{\textsf{}} % Top right header

\renewcommand{\footrulewidth}{1.4pt} % Rule under the footer
\fancyfoot[C]{\textbf{\textsf{\thepage}}} % Bottom center footer

\newcommand{\entry}[4]{\markboth{#1}{#1}\textbf{#1}\ {(#2)}\ \textit{#3}\ $\bullet$\ \newline {#4}}  % Defines the command to print each word on the page, \markboth{}{} prints the first word on the page in the top left header and the last word in the top right
